...
import "./CrowdsaleCommunityFund.sol";

contract CrowdsaleCommunityFundPreSale {
    CrowdsaleCommunityFund public token;
    ...
    function CrowdsaleCommunityFundPreSale(
        CrowdsaleCommunityFund _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = CrowdsaleCommunityFund(_token);
        beneficiary = _beneficiary;
        alfatokenteam = _alfatokenteam;
        bonus = 25;
        price = 100;
        minSaleAmount = 500000000000000000000;
    }
